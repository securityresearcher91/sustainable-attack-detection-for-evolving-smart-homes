...
sudo env "PATH=$PATH" "PYTHONPATH=$PYTHONPATH" /home/sas/dev/env/bin/python detector_rpi.py --target-mac SIMULATOR_MAC --macbook-ip MACBOOK_IP --attacker-mac MACBOOK_IP --camera-mac SIMULATOR_MAC --denylist-file ABUSEDB_DENY_LIST --router-ip ROUTER_IP
```
...
# With second-level analysis
python detector_dl.py --attacker-mac MACBOOK_IP --camera-mac SIMULATOR_MAC --denylist-file ABUSEDB_DENY_LIST --router-ip ROUTER_IP
```
